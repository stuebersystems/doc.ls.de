...
Das Downloadpakte für die für den Übertrag notwendige Anwendung MAGELLAN.CLI finden Sie nachstehend:
[MAGELLAN.CLI für 64 Bit Betriebssysteme](https://download.stueber.de/bin/de/magellan.cli/magellan.cli-x64-de.msi)
[MAGELLAN.CLI für 32 Bit Betriebssysteme](https://download.stueber.de/bin/de/magellan.cli/magellan.cli-x86-de.msi)
