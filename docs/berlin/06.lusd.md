...
1. Importieren Sie diese angepasste Datei bitte erneut, die Schüler werden jetzt mit der LUSD-ID gekennzeichnet und können bei erneuten Importen wieder erkannt werden.
