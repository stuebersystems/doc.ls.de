...
`Daten3 > G8/G9`  |**Für Gymnasien**:<br/>Es werden Schüler ausgegeben, die in einer Klasse mit der Jahrgangsstufe 12 oder 13 sind und einen Eintrag unter `Daten3 > G8/G9` haben (G8 = 12 und G9 = Jahrgang 13). Zum Befüllen des Feldes `G8/G9` steht Ihnen die Sammelzuweisung im `Menü Schüler` auf der Registerkarte `Schüler` zur Verfügung.
